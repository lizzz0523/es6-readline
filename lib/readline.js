...
class ReadLine {
    ...
    readline() {
        return __awaiter(this, void 0, void 0, function* () {
            const { value, done } = yield this.next();
    ...
    getIterator_() {
        return __asyncGenerator(this, arguments, function* getIterator_1() {
            while (true) {
                if (this.isEmpty_()) {
                    yield __await(this.more_());
                }
                const line = yield __await(this.next_());
                if (line === null) {
                    break;
                }
                yield line;
...
exports.MAX_LINE_NUM = ReadLine.MAX_LINE_NUM;
function createReadLine(input, encoding = 'utf-8') {
...
exports.default = createReadLine;
